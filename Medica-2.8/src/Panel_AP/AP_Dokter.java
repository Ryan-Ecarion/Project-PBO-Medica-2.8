...
public class AP_Dokter extends javax.swing.JPanel {
    ...
    public AP_Dokter() {
        initComponents();
        connectDatabase(); // Hubungkan ke database
        loadTable(); // Muat data ke JTable
        setButtonListeners(); // Tambahkan aksi ke tombol
    ...
    private void loadTable() {
        ...
        String query = "SELECT nama, jenis_kelamin, no_telepon, alamat FROM dokter";
    ...
    private void setButtonListeners() {
        Tambah.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (validateFields()) {
                    ...
                    JOptionPane.showMessageDialog(AP_Dokter.this, "Semua field harus diisi!");
                }
            }
        });
        ...
        Daftar_Dokter.getSelectionModel().addListSelectionListener(e -> {
    ...
    private void tambahData() {
        ...
        String query = "INSERT INTO dokter (nama, no_telepon, alamat, jenis_kelamin) VALUES (?, ?, ?, ?)";
   ...
   // Edit data
        private void editData() {
            int selectedRow = Daftar_Dokter.getSelectedRow();
            if (selectedRow == -1) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                String query = "UPDATE dokter SET nama=?, no_telepon=?, alamat=?, jenis_kelamin=? WHERE nama=?";
    ...
    int confirm = JOptionPane.showConfirmDialog(this, 
            "Apakah Anda yakin ingin menghapus data dokter dengan nama \"" + nama + "\"?", 
            "Konfirmasi Hapus Data", 
            JOptionPane.YES_NO_OPTION);

    // Jika pengguna memilih "Tidak", batalkan operasi hapus
    if (confirm != JOptionPane.YES_OPTION) {
        return;
    }

    String query = "DELETE FROM dokter WHERE nama=?";
    ...
    private void initComponents() {
        ...
        Daftar_Dokter = new javax.swing.JTable();
        ...
        Daftar_Dokter.setFont(new java.awt.Font("Futura Bk BT", 0, 12)); // NOI18N
        Daftar_Dokter.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        Daftar_Dokter.setGridColor(new java.awt.Color(0, 102, 102));
        jScrollPane3.setViewportView(Daftar_Dokter);
        ...
        txt_daftar.setText("Daftar Dokter");
    ...
    private javax.swing.JTable Daftar_Dokter;
