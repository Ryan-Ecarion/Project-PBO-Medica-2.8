...
public class AP_Jadwal extends javax.swing.JPanel {
    ...
    private void loadComboData() {
        try (Statement stmt = conn.createStatement()) {
            ...
            // Load Status
            String[] statusOptions = {"Terjadwal", "Selesai", "Dibatalkan"};
    ...
    private void initComponents() {
        ...
        panelRound1.add(Tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 230, 170, 30));

        Hapus.setBackground(new java.awt.Color(255, 102, 102));
        Hapus.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        Hapus.setForeground(new java.awt.Color(255, 255, 255));
        Hapus.setText("HAPUS");
        panelRound1.add(Hapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 270, 170, 30));
        ...
        panelRound1.add(refresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 310, 170, 30));
        ...
        add(Status, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 210, 170, 30));
